      ...
      <Popover.Root>
        <Popover.Trigger asChild>
          <button
            ...
            aria-expanded="false"
            className={cn(
              'w-full min-h-[42px] border border-dark-200 rounded-md px-2 lg:px-4 py-2 small-1-md text-left text-dark-900 flex flex-wrap items-center gap-2 focus:outline-none focus:ring-2 focus:ring-black',
              error &&
